...
<table class="" align="center" width="90%" height="50%" border="0" cellpadding="0" cellspacing="0">
	<tr valign="top">
		<td>	
			<table align="center" border="0" cellpadding="5" cellspacing="0"  height="" width="100%"  style="background-color:#f5f8f9;">
				<tr>
					...
					<td bgcolor="#f5f8f9" align="center" valign="top">
						<table border="0" cellpadding="5" cellspacing="0"align="center">
							...
							<tr>
								<td></td>
								<td>
									<button type="button" class="btnchange" onclick="save();">Update</button>
								</td>
							</tr>
							<tr>
								<td>
...
<script>
$(".btnchange").button({icons: {primary: "ui-icon ui-icon-refresh"}});
$("#dialog_ok").dialog({
