<?php
/**
* Module Name	:	INTERNAL BARCODE CUSTOMER MAINTENANCE
* Date Created	:	
...
<html>
	<head>
		<title>INTERNAL BARCODE CUSTOMER MAINTENANCE</title>
...
<!--		<script src="/wms/script/disabled.js" language="JavaScript" type="text/javascript"></script>-->
		...
		<script type="text/javascript" src="IB_customer.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">INTERNAL BARCODE CUSTOMER MAINTENANCE</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/maintenance/IB_customer/IB_customer.php');
								?>
							</td>
