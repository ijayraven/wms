...
<div id="divtrxnonmtoitems">
	<form id="frmdata">
	<table border="1" class="tblresult" width="100%" id="tbltrxnonmtoitems">
		<tr id="trtrxno" class="tblresul-tbltdtls-hdr">
		...
		<tr id="tr1" class="trbody">
			...
			<td><input type="text" id="txtitemno1" name="txtitemno1" size="10" class="txtitemnos centered" data-curcnt = '1'></td>
