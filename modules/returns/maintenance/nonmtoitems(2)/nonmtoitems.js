$("document").ready(function(){
	...
	$("#btnsearch").click(function(){
		...
		{
			alert("PLease selsect at least one criterion tp search.");
		}
	...
	$(".addbtn").live("click",function(){
		...
		var newcnt 	= cnt + 1;
		var newtr	=	"";
		newtr	=	"<tr id='tr"+newcnt+"'>";
		newtr	+=		"<td id='tdcurcnt"+newcnt+"' align='center'>"+newcnt+"</td>";
		newtr	+=		"<td><input type='text' id='txtitemno"+newcnt+"' name='txtitemno"+newcnt+"' size='10' class='txtitemnos' data-curcnt = '"+newcnt+"'></td>";
		newtr	+=		"<td id='tditemdesc"+newcnt+"'>&nbsp;</td>";
		newtr	+=		"<td id='tdsrp"+newcnt+"' align='center'>&nbsp;</td>";
		newtr	+=		"<td align='center'><img src='/wms/images/images/action_icon/delete-icon.gif' class='smallbtns rembtn' title='Remove Row' data-curcnt = '"+newcnt+"'></td>";
		newtr	+=	"</tr>";
