<?php
/**
* Module Name	:	PIECEWORKER MAINTENANCE
* Date Created	:	
...
<html>
	<head>
		<title>PIECEWORKER MAINTENANCE</title>
		...
		<script type="text/javascript" src="pieceworker.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">PIECEWORKER MAINTENANCE</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/maintenance/pieceworker/pieceworker.php');
								?>
							</td>
