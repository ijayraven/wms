<?php
/**
* Module Name	:	RETURNS MONITORING PER SR
* Date Created	:	
...
<html>
	<head>
		<title>Returns Monitoring Per SR</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">MPOS MONITORING PER SR</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
							<?php
								include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/reports/returns_monitoring_persr/returns_monitoring_persr.php');
							?>
							</td>
