<?php
/**
* Module Name	:	RETURNS MONITORING PER ITEM
* Date Created	:	
...
<html>
	<head>
		<title>Returns Monitoring Per Item</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">MPOS MONITORING PER STATUS</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/reports/returns_monitoring_perstatus/returns_monitoring_perstatus.php');
								?>
							</td>
