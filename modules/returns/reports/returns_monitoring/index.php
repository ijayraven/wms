<?php
/**
* Module Name	:	RETURNS MONITORING  PER STATUS
* Date Created	:	
...
<html>
	<head>
	<title>Returns Monitoring  Per Status</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/reports/returns_monitoring/returns_monitoring.php');
								?>
							</td>
