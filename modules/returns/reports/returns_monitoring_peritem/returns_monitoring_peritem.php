...
$("document").ready(function(){
	$(".searchcust").keyup(function(evt){
		...
		if(txtcustno != '' || txtcustname != '')
		{
			...
			{
				$.ajax({
						url			:	'returns_monitoring_peritem.php?action=Q_SEARCHCUST&CUSTNO='+txtcustno+'&CUSTNAME='+txtcustname+'&selcusttype='+custtype+"&custcusttype="+custcusttype,
						beforeSend	:	function()
									{
									},
	...
	$(".searchitem").keyup(function(evt){
		...
		if(txtitemno != '' || txtitemdesc!= '')
		{
			...
			{
				$.ajax({
						url			:	'returns_monitoring_peritem.php?action=Q_SEARCHITEM&ITEMNO='+txtitemno+'&ITEMDESC='+txtitemdesc+'&BRAND='+selbrand+"&CLASS="+selclass,
						beforeSend	:	function()
									{
									},
						success		:	function(response)
	...
	$("#btnreport").click(function(){
		...
		if(errmsg == "" && errstatus == "")
		{
			$.ajax({
				type:	"POST",
				data:	dataform,
				url:	"returns_monitoring_peritem.php?action=GETMPOS",
				beforeSend:function(){
