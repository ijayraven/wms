<?php
/**
* Module Name	:	VARIANCE REPORT OLD SCANNING
* Date Created	:	
...
<html>
	<head>
		<title>VARIANCE REPORT OLD SCANNING</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">VARIANCE REPORT OLD SCANNING</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
							<?php
								include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/reports/variance_old_scanning/variance.php');
							?>
							</td>
