<?php
/**
* Module Name	:	MPOS DEFECTIVE REPORT
* Date Created	:	
...
<html>
	<head>
		<title>MPOS DEFECTIVE REPORT</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">MPOS DEFECTIVE REPORT</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
							<?php
								include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/reports/defective/defective.php');
							?>
							</td>
