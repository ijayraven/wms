<?php
/**
* Module Name	:	DEFECTIVE ITEMS MTO
* Date Created	:	
...
<html>
	<head>
		<title>DEFECTIVE ITEMS MTO</title>
...
<!--		<script src="/public_js/jquery-3.0.0.min.js"></script>-->
		...
		<script type="text/javascript" src="def_mto.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">DEFECTIVE ITEMS MTO</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/def_mto/def_mto.php');
								?>
							</td>
