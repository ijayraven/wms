...
<div id="divsearchitems"><br>
	<table width="100%"class="label_text"border="0">
		...
		<tr>
			...
			<td></td>
			<td>
				<input type="button" name="btnsearchitems" id="btnsearchitems" value="SEARCH DEFECTIVE ITEMS" class="btnsearch">
			</td>
		</tr>
	</table>
</div>
...
$("#divtrxmto").dialog({
	...
	closeOnEscape:false,	
	title:'DEFECTIVE RETURN MTO CREATION',
