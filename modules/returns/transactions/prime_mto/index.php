...
<!--		<script src="/public_js/jquery-3.0.0.min.js"></script>-->
		...
		<script type="text/javascript" src="prime_mto.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">PRIME STOCKS MTO</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/prime_mto/prime_mto.php');
								?>
							</td>
