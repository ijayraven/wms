...
else 
{
	...
	while (!$RSGETMTO->EOF) {
		...
		$arrMTO[$BRAND][$CATEGORY][$SUB_CATEGORY][$CLASS][$UNITPRICE][$Location][$SKUNO]["LOCATION"]		=	$Location;
		...
		$arrMTO[$BRAND][$CATEGORY][$SUB_CATEGORY][$CLASS][$UNITPRICE][$Location][$SKUNO]["UNITPRICE"]		=	$UNITPRICE;
		$RSGETMTO->MoveNext();
	}
}
