<?php
/**
* Module Name	:	RAW MTO ISSUANCE - FILLING BIN
* Date Created	:	
...
<html>
	<head>
		<title>RAW MTO ISSUANCE - FILLING BIN</title>
...
<!--		<script src="/wms/script/disabled.js" language="JavaScript" type="text/javascript"></script>-->
		...
		<script type="text/javascript" src="issuance.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">RAW MTO ISSUANCE - FILLING BIN</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/raw/issuance_fb/issuance.php');
								?>
							</td>
