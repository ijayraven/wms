<?php
/**
* Module Name	:	RAW MTO ISSUANCE - PIECEWORK
* Date Created	:	
...
<html>
	<head>
		<title>RAW MTO ISSUANCE - PIECEWORK</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">RAW MTO ISSUANCE - PIECEWORK</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/raw/issuance_pcw/issuance.php');
								?>
							</td>
