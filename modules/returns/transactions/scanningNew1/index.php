...
<!--		<script src="/public_js/jquery-3.0.0.min.js"></script>-->
		...
		<script type="text/javascript" src="scanning.js"></script>
		<link rel="stylesheet"	href="/wms/css/j_styles.css">
		<link rel="stylesheet"	href="/wms/css/style.css">
		<link rel="stylesheet"	href=	"/public_css/select_column.css" />
	</head>
	<body>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">MPOS SCANNING</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/scanningNew/scanning.php');
								?>
							</td>
