<?php
/**
* Module Name	:	FILLING BIN RECEIVING
* Date Created	:	
...
<html>
	<head>
		<title>FILLING BIN RECEIVING</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">FILLING BIN RECEIVNG</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/filling_bin/receiving/receiving.php');
								?>
							</td>
