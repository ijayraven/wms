<?php
/**
* Module Name	:	PIECEWORK RECEIVING
* Date Created	:	
...
<html>
	<head>
		<title>PIECEWORK RECEIVING</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">PIECEWORK RECEIVNG</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/pcw/receiving/receiving.php');
								?>
							</td>
