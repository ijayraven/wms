<?php
/**
* Module Name	:	PIECEWORK MTO UPDATE
...
<html>
	<head>
		<title>PIECEWORK MTO UPDATE</title>
...
<!--		<script src="/wms/script/disabled.js" language="JavaScript" type="text/javascript"></script>-->
		...
		<script type="text/javascript" src="mto_update.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">PIECEWORK MTO RECEIVING AND UPDATE</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/pcw/mto_update/mto_update.php');
								?>
							</td>
