...
<!--		<script src="/wms/script/disabled.js" language="JavaScript" type="text/javascript"></script>-->
		...
		<script type="text/javascript" src="transmittal.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">PCW TRANSMITTAL</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/returns/transactions/pcw/transmittal/transmittal.php');
								?>
							</td>
