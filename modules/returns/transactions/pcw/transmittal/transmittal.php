	        	...
	        	if($RSINSERTTOFB)
	        	{
	        		...
	        		else 
	        		{
	        			while (!$RSGETDTLS->EOF) {
							...
							$NEWGROSSAMT	= $NEWUNITPRICE * $GOODQTY;
							$INSERTDTLS		=	"INSERT INTO WMS_NEW.MTO_FILLINGBINDTL(`TRANSNO`, `MTONO`, `SKUNO`, `DESCRIPTION`, `ITEMSTATUS`,`NEWITEMSTATUS`, `QTY`,`RECQTY`, `GOODQTY`, `NO_OF_BOXES`, `NO_OF_PACK`, `BOXLABEL`, `UNITPRICE`, `NEWUNITPRICE`, `GROSSAMT`,`NEWGROSSAMT`)
												 VALUES('$PIFNO','$MTONO','$SKUNO','$DESCRIPTION','$ITEMSTATUS','$NEWITEMSTATUS','$GOODQTY','$GOODQTY','$GOODQTY','$NO_OF_BOXES','$NO_OF_PACK','$BOXLABEL','$UNITPRICE','$NEWUNITPRICE','$GROSSAMT','$NEWGROSSAMT')";
