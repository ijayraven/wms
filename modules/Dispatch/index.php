    ...
    <td>
        <table width="1100" height="300" border="0" cellpadding="0" cellspacing="0" align="center"><!--optional width and height resize or none-->
            ...
            <tr>
                ...
                <td height="20" style="background-color:#3b64a0; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#00ffff; text-align:center;"><?php echo $targer; ?></td>
            ...
            <tr>
                ...
                <td style="background-color:#e4e9f2; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; text-align:center;">
					...
					<?php
						if ($targer == 'MAIN') 
						{
							include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/Dispatch/scheduler_main.php');
						}
						elseif ($targer == 'SCHEDULER')
						{
							include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/Dispatch/scheduler.php');
						}
						elseif ($targer == 'RECEIVING')
						{
							include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/Dispatch/Received.php');
						}
						elseif ($targer == 'PRINTING')
						{
							include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/Dispatch/printing.php');
						}
					?>
					<!--end of contents//-->                
                </td>
