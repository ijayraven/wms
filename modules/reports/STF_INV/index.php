<?php
/**
* Module Name	:	Confirmed Delivery STF/INV
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/reports/STF_INV/stf_inv.php');
								?>
							</td>
