...
//	}
	 ...
	 * FOR SOF
	 */
	$sel_order_dtl_sof	=	"SELECT CUSTNO,SUM(ORDERQTY)as QTY,SUM(GROSSAMOUNT)as GROSS,SUM(NETAMOUNT)as NET FROM CHRISTMAS_2016.$dtl WHERE CUSTNO IN ('{$custlist}') GROUP BY CUSTNO ";
