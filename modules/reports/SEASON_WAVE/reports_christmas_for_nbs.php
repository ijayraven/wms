...
//	}
	 ...
	 * FOR SOF
	 */
	$sel_order_dtl_sof	=	"SELECT SUM(ORDERQTY)as QTY,SUM(GROSSAMOUNT)as GROSS,SUM(NETAMOUNT)as NET FROM CHRISTMAS_2015.$dtl WHERE CUSTNO IN ('{$custlist}')";
	 ...
	 * FOR PICKING ORDERNO
	 */
	$sel_order_172		=	"SELECT ORDERNO FROM CHRISTMAS_2015.$hdr WHERE ORDERSTATUS = 'For Picking' and PICKLISTNO != '' AND CUSTNO IN ('{$custlist}')";
	...
	$sel_order_hdr_10	=	"SELECT OrderNo FROM $hdr10 WHERE PickListNo != '' and OrderNo in ('{$container}') ";
