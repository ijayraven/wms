...
<script>
	function	CreateReport()
	{
		...
		if(islist==true)
		{
			var url_		= 'reports_bts_list.php?action=GENERATE&OPT='+selsearch+'&OPT2='+opt;
		}
		else if(issummary==true)
		{
			var url_		= 'reports_bts_summary.php?action=GENERATE&OPT='+selsearch+'&OPT2='+opt;
			
		}
		else if(isdetailed==true)
		{
			var url_		= 'reports_bts.php?action=GENERATE&OPT='+selsearch+'&OPT2='+opt;
		}
		window.open(url_);
	}
