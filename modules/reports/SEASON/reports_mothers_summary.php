<?php
	 ...
	 * FOR SOF
	 */
	//$sel_order_hdr_sof	=	"SELECT ORDERNO FROM MOTHERSDAY_2016.$hdr WHERE ORDERSTATUS='For Picking' ";
	if ($_GET['OPT2'] != 'ALL')
	{
		$sel_order_hdr_sof	=	"SELECT ORDERNO FROM MOTHERSDAY_2016.$hdr WHERE ORDERSTATUS='For Picking' AND CUSTNO in ('{$custlist}')";
	}
	else {
		$sel_order_hdr_sof	=	"SELECT ORDERNO FROM MOTHERSDAY_2016.$hdr WHERE ORDERSTATUS='For Picking' ";
	}
	...
	$sel_order_dtl_sof	=	"SELECT SUM(ORDERQTY)as QTY,SUM(GROSSAMOUNT)as GROSS,SUM(NETAMOUNT)as NET FROM MOTHERSDAY_2016.$dtl WHERE ORDERNO IN('{$SOFLIST}')";
	 ...
	 * FOR PICKING ORDERNO
	 */
	//$sel_order_172		=	"SELECT ORDERNO FROM MOTHERSDAY_2016.$hdr WHERE ORDERSTATUS = 'For Picking' and PICKLISTNO != '' ";
	if ($_GET['OPT2'] != 'ALL') 
	{
		$sel_order_172		=	"SELECT ORDERNO FROM MOTHERSDAY_2016.$hdr WHERE ORDERSTATUS = 'For Picking' and PICKLISTNO != '' AND CUSTNO in ('{$custlist}') ";
	}
	else 
	{
		$sel_order_172		=	"SELECT ORDERNO FROM MOTHERSDAY_2016.$hdr WHERE ORDERSTATUS = 'For Picking' and PICKLISTNO != '' ";
