...
//exit();
		...
		if ($cnt > 0) 
		{
			while (!$rssel_val_cust->EOF) 
			{
				...
				{
				$branch_code	=	$global_func->Select_val($Filstar_conn,"FDCRMSlive","custmast","NBSnewBranchCode","CustNo = '{$CUSTNO}' ");	
				}
			...
			//echo $sof 		=	implode("','",$sof_list);exit();
			//echo count($sof_list);exit();
