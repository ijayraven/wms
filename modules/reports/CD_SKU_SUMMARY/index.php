<?php
/**
* Module Name	:	Confirmed Delivery SKU Summary
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">SKU Summary</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
							<?php
								include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/reports/CD_SKU_SUMMARY/sku_summary.php');
							?>
					 		</td>
