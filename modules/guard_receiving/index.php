<?php
/**
* Module Name	:	GUARD'S RECEIVING (PO ACTIVATION)
* Date Created	:	
...
<html>
	<head>
		<title>GUARD'S RECEIVING PO ACTIVATION</title>
		...
		<script type="text/javascript" src="guard_receiving.js"></script>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">GUARD'S RECEIVING (PO ACTIVATION)</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/guard_receiving/guard_receiving.php');
								?>
							</td>
