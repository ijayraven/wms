<?php
/**
* Module Name	:	ITEM APPROVAL CREATION
...
<html>
	<head>
		<title>ITEM APPROVAL CREATION</title>
			    ...
			    <td align="center">
			        <table class="main-tbl-2" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			                ...
			                <td class="td-title">ITEM APPROVAL CREATION</td>
			            ...
			            <tr>
			                ...
			                <td class="td-content">
								<?php
									include($_SERVER['DOCUMENT_ROOT'].'/wms/modules/item_approval/creation/creation.php');
								?>
							</td>
