			...
			<table width="100%" height="24" border="0" cellpadding="0" cellspacing="0" style="background-image:url(images/menubg.gif); background-repeat: repeat-x;">
				<tr>
					...
					<td align="right" style="font-family: Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold; color:#6CD9C3; text-align:right;">
						HI&nbsp; <?php echo $global_func->Login_user2($Filstar_conn,$_SESSION['username']); ?>!&nbsp;&nbsp;
									...
									<div id="page-container">
									  <ul id="navmenu-v">
                                		...
                                		<li><a target="mainFrame"><strong>REPORTS</strong></a>
                                			<ul>
                                				<?php if(($global_func->GetAccess2($Filstar_conn,$_SESSION['username'],'REPORTS','SEASON_CHR')) or ($global_func->GetAccess2($Filstar_conn,$_SESSION['username'],'REPORTS','SEASON_VAL')) or ($global_func->GetAccess2($Filstar_conn,$_SESSION['username'],'REPORTS','SEASON_BTS')) or ($global_func->GetAccess2($Filstar_conn,$_SESSION['username'],'REPORTS','SEASON_MOTHERS'))) {?>
												<li><a>SEASON</a>
													<ul>
												...
												<?php };?>
												<?php if(($global_func->GetAccess2($Filstar_conn,$_SESSION['username'],'REPORTS','CONF_DEL_SKUSUMMARY')) or ($global_func->GetAccess2($Filstar_conn,$_SESSION['username'],'REPORTS','CONF_DEL_STF_INV'))){ ?>
											...
											<ul>
												<li><a href="#">TRANSACTIONS</a>
													<ul>
														...
														<li><a href="modules/returns/transactions/ex_mto" target="mainFrame">EXCLUSIVE MTO</a></li>
														
														<li><a href="modules/returns/inventory/persku" target="mainFrame">INVENTORY</a></li>
													</ul>
												</li>
												<li><a href="#">REPORTS</a>
										...
										<li><a href="#"><strong>MAINTENANCE</strong></a>
											<ul>
												...
												<li><a href="modules/returns/maintenance/nonmtoitems" target="mainFrame">EXCLUSIVE ITEMS</a></li>
												<?php }?>
											</ul>
										</li>
